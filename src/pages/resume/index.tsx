      ...
      <MotionBox css={rightBoxStyle()} motionType="FADE_IN_RIGHT">
        ...
        <div css={experienceBoxStyle()}>
          <Article
            ...
            main="NC ITS"
            sub="2022.07 - 재직중"
            content="사내 서비스를 제공하는 NC SOFT의 자회사로 전사에서 사용하는 내부 서비스의 Web, App의 프론트엔드 부분을 담당하였고, 입사시 팀은 구성되어 있으나 개발하기 위해 필요한 협업 부분이 다소 많이 부족하다 생각되어 Git Flow, Git 정책, PR, 코드 컨벤션, 문서화 등 협업에 필요한 부분을 적극 도입 및 제안 하였으며 도입한 내용에 대해 리뷰 진행"
          />
          <Article
            main="스테이지파이브"
            sub="2021.01 - 2022.06"
          ...
          <Article
            main="빌드잇"
            sub="2019.04 - 2020.12"
            content="IOT 제품 및 서비스를 제공하는 B2B 스타트업 회사로 외부 IOT 서비스, 자사 IOT 서비스의 Web, App의 프론트엔드 부분을 담당하였고, 주로 사내에서 개발한 SDK를 통하여 제품 및 기기를 연결하고 차트를 통한 데이터 시각화를 중점적으로 개발 진행"
          />
          <Article
            main="아토스"
            sub="2017.01 - 2018.12"
